...
class TVTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellIdentifier = "TVTableViewCell"
        
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as? TVTableViewCell  else {
            fatalError("The dequeued cell is not an instance of TVTableViewCell.")
        }
            ...
            if error != nil {
                ...
                do {
                    ...
                    for NSDictionary in parsedData{
                        ...
                        guard let tempShow = Show(name: tempShowName as! String, photo: tempImage) else {
